...
$testModules = [
    ...
    [
        ...
        'endpoint' => 'tests/test-google-oauth.php',
        'type' => 'auto',
    ...
    [
        ...
        'endpoint' => 'tests/test-profile.php',
        'type' => 'link', // Opens in same window
        'description' => 'Debug script to check profile.php accessibility and dependencies'
    ],
    [
        'id' => 'google-callback-debug',
        'title' => 'Google OAuth Callback Debug',
        'endpoint' => 'tests/test-google-callback-debug.php',
        'type' => 'link', // Opens in same window
        'description' => 'Debug script to identify Google OAuth callback issues'
    ],
    [
        'id' => 'manual',
    ...
    <div class="container">
        ...
        <div class="instructions alert alert-info">
            ...
            <ul>
                ...
                <li>For detailed testing instructions, see <code>docs/TESTING_GUIDE.md</code></li>
            </ul>
        </div>
