...
function cardobot_house_art_style(): string {
    return 'STYLE NAME: Card-o-Bot Gouache (mandatory house look on every card). '
        ...
        . 'Face and expression must fit the subject type, not a one-size robot default. '
        . 'People, androids, critters, strangers, and friendly bots may have a clear readable face when that fits. '
        . 'Cute or soft subjects may look cute; stern, scarred, alien, or odd subjects should look that way too. '
        . 'Clunky, ugly, industrial, or giant machines (crane, hauler, wrecker, etc.) may use a more implied face: '
        . 'a slit, lamp, grille, sensor cluster, or other hardware that reads as presence without a cute mascot face. '
        . 'Do not force sparkle-eyed stock-mascot faces onto subjects that should feel heavy, crude, human, alien, or inhuman. '
